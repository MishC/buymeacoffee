...
export function linksSticky() {
  return (
    <div className="">
      <div className="faq">
        <a href="https://www.buymeacoffee.com/faq">
          {" "}
          <svg
            width="24"
            height="24"
          ...
          >
            ...
            ></path>
            <path
              d="M7.99963 13C7.63159 13 7.33301 12.7014 7.33301 12.3334C7.33301 11.9653 7.63159 11.6667 7.99963 11.6667C8.36768 11.6667 8.66626 11.9653 8.66626 12.3334C8.66626 12.7014 8.36768 13 7.99963 13Z"
              fill="#fff"
            ></path>
            <path
              d="M9.0553 8.76135C8.81934 8.87 8.66663 9.10803 8.66663 9.36743V9.66675C8.66663 10.0347 8.36865 10.3334 8 10.3334C7.63135 10.3334 7.33337 10.0347 7.33337 9.66675V9.36743C7.33337 8.58936 7.79065 7.8761 8.4967 7.55005C9.17603 7.23743 9.66663 6.40735 9.66663 6C9.66663 5.08142 8.91931 4.33337 8 4.33337C7.08069 4.33337 6.33337 5.08142 6.33337 6C6.33337 6.36804 6.03528 6.66675 5.66663 6.66675C5.29797 6.66675 5 6.36804 5 6C5 4.34607 6.34595 3 8 3C9.65405 3 11 4.34607 11 6C11 6.90076 10.2186 8.22473 9.0553 8.76135Z"
              fill="#fff"
            ></path>
          </svg>{" "}
          <span>FAQ</span>
      ...
      <div className="help">
        <a
          target="_blank"
          href="https://help.buymeacoffee.com/"
          rel="nofollow noopener noreferrer"
        >
          {" "}
          <svg
